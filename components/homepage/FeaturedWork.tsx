...
const featuredCaseStudies = [
  {
    ...
    tags: ['2024-2025', 'Cross-Platform Integration', 'Product Strategy', 'User Research', 'End-to-End'],
    metrics: [
  ...
  },
  {
    ...
    title: 'Establishing Design Standards That Actually Get Used',
    ...
    tags: ['2024', 'Design Systems', 'Design Components', 'Developer Collaboration', 'Incremental Change'],
    metrics: [
